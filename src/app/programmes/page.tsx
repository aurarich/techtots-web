			...
			<section className="relative py-20 overflow-hidden">
				<div className="container">
					<div className="max-w-3xl mx-auto mb-12 text-center">
						<HeaderTag title="Our Learning Journey" />
						...
						<p className="text-xl text-gray-600">
							...
							growth, curiosity, and discovery. Our inspiring learning pathway guides
							children step by step from their earliest experiences to confident,
							inquisitive learners ready for the future.
						</p>
					</div>
					<div className="grid gap-10 md:grid-cols-2 lg:grid-cols-2">
						{ourProgrammes.map((prog, idx) => (
							<div
								key={idx}
								className={`relative flex flex-col justify-between overflow-hidden transition-transform border rounded-2xl shadow-lg bg-white border-${prog.color}/10 hover:scale-105 group`}
							>
								<div className="p-8">
									<h2 className="mb-2 text-2xl font-extrabold tracking-tight text-primary font-heading">
										{prog.title}
									</h2>
								...
								<div className="px-8 pb-8">
									<Link
										...
										className={`w-full text-center btn ${prog.btnColor}`}
									>
										Learn More
									</Link>
								</div>
