...
export default function Home() {
  return (
    <>
          ...
          <div className="container relative z-20">
            <div className="max-w-6xl mx-auto space-y-16 text-center">
              ...
              <div className="space-y-6">
                {/* Enhanced Badge */}
                <HeaderTag title="Now Enrolling for September 2025" />
        ...
        {/* Features Section */}
        <section className="relative overflow-hidden section bg-gradient-to-b from-beige/30 to-[#0EA5E9]/10">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-beige/20 via-transparent to-transparent" />
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-0 left-0 w-full h-full">
              <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-beige/20 rounded-full mix-blend-multiply filter blur-3xl animate-blob" />
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
              {[
                ...
                return (
                  ...
                  >
                    <div
                      className={`flex items-center justify-center h-48 mb-6 rounded-lg ${bgColor} animate-pulse-slow`}
                    >
                      <program.icon className={`w-16 h-16 ${iconColor}`} />
                    </div>
        ...
        <section className="relative overflow-hidden section bg-gradient-to-b from-[#F5F5DC]/30 to-[#0EA5E9]/10">
          ...
          <div className="container relative z-10">
            <div className="mb-16 text-center">
              ...
              <p className="max-w-2xl mx-auto text-xl text-gray-600">
                A launchpad for tomorrow's innovators with cutting-edge
          ...
          <div className="container relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="mb-8 text-xl text-gray-600">
                Take the first step towards your child's future in technology
                and innovation.
              </p>
