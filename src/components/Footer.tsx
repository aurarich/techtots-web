        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Africa’s most forward-thinking Early Years and Primary institution — where innovation, creativity, and global citizenship begin in the earliest years.
            </p>
            <div className="flex space-x-4">
              <a 
                ...
                className="text-gray-400 hover:text-[#F5E6D3] transition-colors"
                aria-label="Facebook"
              >
              ...
              <a 
                href="https://youtube.com/techtots" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="text-gray-400 hover:text-[#F5E6D3] transition-colors"
                aria-label="YouTube"
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/admissions" className="text-gray-400 hover:text-[#F5E6D3] transition-colors">
                  Admissions
                </Link>
              </li>
              <li>
          ...
          <div>
            <h4 className="mb-4 text-lg font-semibold font-heading">Newsletter</h4>
            <p className="mb-4 text-gray-400">Subscribe to our newsletter for updates and news.</p>
            <form className="space-y-3">
              <input
                type="email"
                placeholder="Enter your email"
                className="w-full px-4 py-2 rounded-lg bg-gray-800 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#F5E6D3]"
              />
